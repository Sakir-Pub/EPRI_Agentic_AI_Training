...
safe calculator tool, real web search tool, file summarization tool, and step-by-step logging.
...
def run_react_loop(prompt: str, user_question: str, max_steps: int = 5):
    ...
    for step in range(max_steps):
        ...
        if expr:
            ...
            continue  # force next step before accepting Final Answer
        ...
        # Only stop if no tools were invoked this round
